package punk.ui.skins
{
	 ...
	 */
	public class BlackAndWhite extends PunkSkin
	{
		/**
		 * The asset to use for the skin images
		 */
		[Embed(source="BlackAndWhite1.png")] protected const I:Class;
		 ...
		 */
		public function BlackAndWhite(roundedButtons:Boolean = false, passwordField:int = 2, textArea:int = 0, textField:int = 1, windowCaption:int = 0, windowBody:int = 0)
		{
			super();
			...
			punkButton = new PunkSkinButtonElement(gy(0, by), gy(16, by), gy(32, by), gy(16, by), {color: 0xFFFFFF, size: 16});
			
			punkToggleButton = new PunkSkinToggleButtonElement(gn(0, 64), gn(16, 64), gn(32, 64), gn(16, 64), gn(0, 80), gn(16, 80), gn(32, 80), gn(16, 80), {color: 0xFFFFFF, size: 16, x: 16});
			punkRadioButton = new PunkSkinToggleButtonElement(gn(0, 96), gn(16, 96), gn(32, 96), gn(16, 96), gn(0, 112), gn(16, 112), gn(32, 112), gn(16, 112), {color: 0xFFFFFF, size: 16, x: 16});
			
			punkLabel = new PunkSkinHasLabelElement({color: 0xFFFFFF, size: 16});
			punkTextArea = new PunkSkinLabelElement({color: 0xFFFFFF, size: 16}, gy(64 + (16 * textArea), 0));
			punkTextField = new PunkSkinLabelElement({color: 0xFFFFFF, size: 16}, gy(64 + (16 * textField), 16));
			punkPasswordField = new PunkSkinLabelElement({color: 0xFFFFFF, size: 16}, gy(16 * passwordField, 48));
			
			punkWindow = new PunkSkinWindowElement(gy(64 + (16 * windowCaption), 33, 16, 15), gy(64 + (16 * windowBody), 47, 16, 17), {color: 0xFFFFFF, size: 16, x: 2, y: -1});
		}
