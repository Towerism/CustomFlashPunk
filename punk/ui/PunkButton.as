package punk.ui
{
	...
	{	
		...
		public function set alpha(value:Number):void {
			Image(normalGraphic).alpha = value;
			Image(mousedGraphic).alpha = value;
			Image(inactiveGraphic).alpha = value;
			Image(pressedGraphic).alpha = value;
			label.alpha = value;
		}
		
		public function get alpha():Number {
			return Image(normalGraphic).alpha;
		}
